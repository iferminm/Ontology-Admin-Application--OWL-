...
MyStatement targetClass = null;
Iterator<MyStatement> classIterator = classes.iterator();
...
TreeSet<MyStatement> options = om.oneResultQuery("?s", conditions);
...
if (options.size() > 0) {
	Iterator<MyStatement> iter = options.iterator();
